package com.weiller.springcloudprivider.hello.service.impl;

import com.weiller.springcloudprivider.hello.entity.Msg;
import com.weiller.springcloudprivider.hello.service.HelloService;
...
public class HelloServiceImpl implements HelloService{
    ...
    public Mono<Msg> sayOnce() {
        Msg msg = new Msg();
        msg.setCode("200");
        msg.setMsg("hello world ,I am privider 8002");
